...
const AboutMe = () => (
  <section
    id="about"
    className="min-h-screen flex items-center justify-center bg-white text-black dark:bg-transparent dark:text-white px-6 md:px-20 py-16 transition-colors duration-500 relative overflow-hidden"
  >
    <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-10 relative z-10">
      ...
      <motion.img
        ...
        className="w-52 sm:w-60 md:w-64 h-72 sm:h-80 md:h-96 rounded-xl shadow-lg object-cover animate-blue-glow hover-lift glow-border"
      ...
      <div className="text-center md:text-left flex-1">
        <motion.h3
          className="text-4xl font-bold font-heading mb-6 animate-text-shimmer"
        ...
        <motion.p
          className="text-base sm:text-[1rem] leading-relaxed text-black dark:text-white/90 hover-lift p-4 rounded-lg bg-white/50 dark:bg-black/20 backdrop-blur-sm"
          initial={{ opacity: 0 }}
    ...
    {/* Decorative Elements */}
    <motion.div
      className="absolute top-10 right-10 w-8 h-8 border-2 border-blue-400/30 dark:border-green-400/30 rounded-lg"
      animate={{
        rotate: [0, 360],
        scale: [1, 1.1, 1],
      }}
